package com.wahoofitness.samples.hardwareconnectorservice.service;
...
import com.wahoofitness.samples.hardwareconnectorservice.service.HardwareConnectorService.HardwareConnectorServiceBinder;
...
public abstract class HardwareConnectorServiceConnection {
	...
	private final ServiceConnection mServiceConnection = new ServiceConnection() {
		...
		public void onServiceConnected(ComponentName className, IBinder ibinder) {
			...
			HardwareConnectorService service = binder.getService();
			mService = service;
