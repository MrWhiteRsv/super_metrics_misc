...
def make_fake_trip(outfile_name):
  ...
  write_ble_event(mac = '34:b1:f7:d3:91:c8', outfile = outfile, state = state)
  ...
  write_ble_event(mac = '34:b1:f7:d3:91:e4', outfile = outfile, state = state)
    
  write_fake_segment(num_rev = 10, forward = True, outfile = outfile, state = state)
  write_ble_event(mac = '34:b1:f7:d3:9d:eb', outfile = outfile, state = state)
